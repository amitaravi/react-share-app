...
create_cxx_tasks
  create-initial-cxx-model
    create-module-model
      create-cmake-model 231ms
    create-module-model completed in 235ms
    ...
    create-module-model
      [gap of 10ms]
      create-cmake-model 239ms
    create-module-model completed in 249ms
    create-variant-model 10ms
    [gap of 16ms]
    create-X86-model 16ms
  create-initial-cxx-model completed in 599ms
...
create_cxx_tasks
  create-initial-cxx-model
    create-module-model
      create-cmake-model 102ms
    create-module-model completed in 111ms
    create-ARMEABI_V7A-model 10ms
    create-X86-model 22ms
    create-X86_64-model 18ms
    create-module-model
      create-cmake-model 124ms
    create-module-model completed in 134ms
...
create_cxx_tasks
  create-initial-cxx-model
    ...
    create-module-model
      create-cmake-model 197ms
    create-module-model completed in 207ms
    create-ARMEABI_V7A-model 10ms
